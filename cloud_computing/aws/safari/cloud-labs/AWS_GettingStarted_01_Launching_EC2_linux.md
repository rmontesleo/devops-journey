# Getting Started with Amazon EC2 : Step 1. Launching a Basic Linux Virtual Machine


## Lab
```bash

# To login in the console of your AWS console
...
## Create resoureces script 1_create_resources.sh
```bash
...
- [Launching a Basic Linux Virtual Machine](https://learning.oreilly.com/scenarios/getting-started-with/9781098135997/)